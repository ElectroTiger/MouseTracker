...
${OBJECTDIR}/_ext/f30a23f9/Utilities.o: ../raspberrypi_omxcam/include/Utilities.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f30a23f9/Utilities.o ../raspberrypi_omxcam/include/Utilities.cpp
...
${OBJECTDIR}/decadriver/deca_device.o: decadriver/deca_device.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/decadriver/deca_device.o decadriver/deca_device.c

${OBJECTDIR}/decadriver/deca_params_init.o: decadriver/deca_params_init.c
	${MKDIR} -p ${OBJECTDIR}/decadriver
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/decadriver/deca_params_init.o decadriver/deca_params_init.c
...
${TESTDIR}/tests/CameraThreadTest.o: tests/CameraThreadTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CameraThreadTest.o tests/CameraThreadTest.cpp
...
${OBJECTDIR}/_ext/f30a23f9/Utilities_nomain.o: ${OBJECTDIR}/_ext/f30a23f9/Utilities.o ../raspberrypi_omxcam/include/Utilities.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f30a23f9/Utilities_nomain.o ../raspberrypi_omxcam/include/Utilities.cpp;\
	else  \
...
${OBJECTDIR}/CameraThread_nomain.o: ${OBJECTDIR}/CameraThread.o CameraThread.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CameraThread_nomain.o CameraThread.cpp;\
	else  \
...
${OBJECTDIR}/DWM1000Thread_nomain.o: ${OBJECTDIR}/DWM1000Thread.o DWM1000Thread.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DWM1000Thread_nomain.o DWM1000Thread.cpp;\
	else  \
...
${OBJECTDIR}/decadriver/deca_device_nomain.o: ${OBJECTDIR}/decadriver/deca_device.o decadriver/deca_device.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/decadriver/deca_device_nomain.o decadriver/deca_device.c;\
	else  \
...
${OBJECTDIR}/decadriver/deca_params_init_nomain.o: ${OBJECTDIR}/decadriver/deca_params_init.o decadriver/deca_params_init.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/decadriver/deca_params_init_nomain.o decadriver/deca_params_init.c;\
	else  \
